...
import type { CollectionRequestParams, CollectionResponse, Item, SingleRequestParams, SingleResponse, StrapiRequestParams, StrapiResponse } from "@/lib/types";
...
export class StrapiService extends ApiService<StrapiResponse, StrapiRequestParams> {
    static override createOptions(options: StrapiServiceOptions): Required<StrapiServiceOptions> {

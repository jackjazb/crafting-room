...
export type ApiAboutPageAboutPage = {
...
export type ApiArtistArtist = {
    ...
    attributes: {
        ...
        > &
        Schema.Attribute.Required;
        links: Schema.Attribute.Component<"artist.social-link", true>;
        locale: Schema.Attribute.String & Schema.Attribute.Private;
        localizations: Schema.Attribute.Relation<
            "oneToMany",
            "api::artist.artist"
...
export type ApiArtistsPageArtistsPage = {
    collectionName: "artists_pages";
    info: {
        description: "";
        displayName: "Artists Page";
        pluralName: "artists-pages";
        singularName: "artists-page";
    };
    options: {
        draftAndPublish: true;
    };
    attributes: {
        ...
        createdBy: Schema.Attribute.Relation<"oneToOne", "admin::user"> &
        Schema.Attribute.Private;
        groups: Schema.Attribute.Component<"artist.artist-group", true>;
        inactive: Schema.Attribute.Component<"artist.artist-group", false>;
        locale: Schema.Attribute.String & Schema.Attribute.Private;
        localizations: Schema.Attribute.Relation<
            "oneToMany",
            "api::artists-page.artists-page"
        > &
        Schema.Attribute.Private;
        publishedAt: Schema.Attribute.DateTime;
        updatedAt: Schema.Attribute.DateTime;
...
export type ApiHomepageHomepage = {
    ...
    attributes: {
        ...
        createdBy: Schema.Attribute.Relation<"oneToOne", "admin::user"> &
        Schema.Attribute.Private;
        features: Schema.Attribute.Relation<"oneToMany", "api::article.article">;
        locale: Schema.Attribute.String & Schema.Attribute.Private;
        localizations: Schema.Attribute.Relation<
            "oneToMany",
...
export type ApiReleaseRelease = {
    ...
    attributes: {
        ...
        artwork: Schema.Attribute.Media<"images"> & Schema.Attribute.Required;
        createdAt: Schema.Attribute.DateTime;
        createdBy: Schema.Attribute.Relation<"oneToOne", "admin::user"> &
        Schema.Attribute.Private;
...
export type ApiStorePageStorePage = {
    ...
    attributes: {
        ...
        createdBy: Schema.Attribute.Relation<"oneToOne", "admin::user"> &
        Schema.Attribute.Private;
        groups: Schema.Attribute.Component<"release.release-group", true>;
        locale: Schema.Attribute.String & Schema.Attribute.Private;
        localizations: Schema.Attribute.Relation<
            "oneToMany",
